...
namespace tools {
	...
	*/
	...
	/*
	* Fill a sparse matrix. For each vertex i of V, its neighbours j, 
	* S(i,j) = distance(Vi, Vj)
	* S(i,i) = Sum (S(i,j))
	* 
	* @param V	Mesh vertices
	* @param F	Mesh Faces
	* @param S	Sparse matrix to be filled
	*/
	...
	/*
	* Computes the sum of the area of all faces of a mesh
	* 
	* @param V Mesh vertices
	* @param F Mesh Faces
